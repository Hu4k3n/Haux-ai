...
def play_sound(i):
    i=int(i)
    if i==0 :
        u=([f for f in listdir("audio/start/") if isfile(join("audio/start/", f))])
        u=random.choice(u)
        playsound("audio/start/"+str(u))
    elif i== 1 :
        u=([f for f in listdir("audio/mid/") if isfile(join("audio/mid/", f))])
        u=random.choice(u)
        playsound("audio/mid/"+str(u))
    elif i==2 :
        u=([f for f in listdir("audio/end/") if isfile(join("audio/end/", f))])
        u=random.choice(u)
        playsound("audio/end/"+str(u))
